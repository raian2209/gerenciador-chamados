...
│   │   └── webapp/WEB-INF/jsp/              -> páginas JSP organizadas por perfil e fragments reutilizáveis
│   └── test/
│       └── java/br/com/dunnastecnologia/chamados/
│           └── infrastructure/              -> testes unitários e de integração focados na infraestrutura
...
- O serviço `app` também recebe, via ambiente, as variáveis de bootstrap do administrador e de configuração do scheduler de atraso.
...
- Verifica propagação de filtros por status, tipo de chamado e unidade.
...
- Verifica paginação na listagem dos próprios chamados.
