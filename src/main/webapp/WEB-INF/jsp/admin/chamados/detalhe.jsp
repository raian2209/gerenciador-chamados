            ...
            <section class="detail-grid">
                <article class="card">
                    ...
                    <c:if test="${not chamado.finalizado}">
                        ...
                        <form method="post" action="${ctx}/admin/chamados/${chamado.id}/finalizar" class="inline-form" data-confirm="Finalizar este chamado?">
                            <%@ include file="/WEB-INF/jsp/fragments/csrf.jspf" %>
                ...
                <article class="card">
                    ...
                    <form method="post" action="${ctx}/admin/chamados/${chamado.id}/comentarios" class="stack-form">
                        <%@ include file="/WEB-INF/jsp/fragments/csrf.jspf" %>
                        <label class="field">
